...
router.get('/customer/:id/orders', (req, res) => {
  const text = `SELECT o.*, v.vendorname FROM orders o
      JOIN customer c on o.customerid = c.customerid
      JOIN vendor v on v.vendorid = o.orderid
...
router.get('/vendor/:id/orders', (req, res) => {
  const text = `SELECT o.*, c.customername FROM orders o
...
router.get('/order/:id', (req, res) => {
  const text = `SELECT o.*, d.*, v.vendorname FROM orders o
    JOIN vendor v on v.vendorid = o.vendorid
